...
//
// Copied from the `@shadcn/empty` registry item (radix-nova style, MIT) with
// `cn-font-heading` swapped for this repository's `font-heading`. Kept local so
// the planning-only map installs nothing into `src/shared/ui`; if a variant with
// this treatment wins, install the real primitive in the implementation ticket.

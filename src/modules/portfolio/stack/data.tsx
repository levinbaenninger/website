...
export const TECH_STACK = [
    ...
    items: [
      {
        ...
        icon: <TypeScript aria-hidden />,
        title: "TypeScript",
      },
      {
        href: "https://dotnet.microsoft.com/languages/csharp",
        icon: <CSharp aria-hidden />,
        title: "C#",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: <Angular aria-hidden />,
        title: "Angular",
      },
      {
        href: "https://nextjs.org",
        icon: <Nextjs aria-hidden />,
        title: "Next.js",
      },
      {
        href: "https://tanstack.com",
        icon: <TanStack aria-hidden />,
        title: "TanStack",
      },
      {
        href: "https://ngrx.io",
      ...
      {
        href: "https://rxjs.dev",
        icon: <RxJS aria-hidden />,
        title: "RxJS",
      },
      {
        href: "https://tailwindcss.com",
        icon: <TailwindCSS aria-hidden />,
        title: "Tailwind CSS",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: <MicrosoftNET aria-hidden />,
        title: ".NET",
      },
      { href: "https://trpc.io", icon: <TRPC aria-hidden />, title: "tRPC" },
    ],
  },
  {
    category: "Database",
  ...
  },
  {
    category: "Workflow",
    items: [
      { href: "https://git-scm.com", icon: <Git aria-hidden />, title: "Git" },
      {
      ...
      { href: "https://vite.dev", icon: <Vite aria-hidden />, title: "Vite" },
    ],
  },
  {
    category: "Testing",
    items: [
      { href: "https://jestjs.io", icon: <Jest aria-hidden />, title: "Jest" },
      {
        href: "https://vitest.dev",
        icon: <Vitest aria-hidden />,
        title: "Vitest",
      },
      {
        href: "https://playwright.dev",
        icon: <Playwright aria-hidden />,
        title: "Playwright",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: <MicrosoftAzure aria-hidden />,
        title: "Azure",
      },
      {
        href: "https://www.cloudflare.com",
        icon: <Cloudflare aria-hidden />,
        title: "Cloudflare",
      },
    ],
  },
...
export type TechStackCategory = (typeof TECH_STACK)[number];
export type TechStackItem = TechStackCategory["items"][number];
